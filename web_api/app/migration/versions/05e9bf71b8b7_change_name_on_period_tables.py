...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['service_id'], ['service.id'], name='unavailable_periods_service_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['service_id'], ['service.id'], name='working_hours_service_id_fkey'),
