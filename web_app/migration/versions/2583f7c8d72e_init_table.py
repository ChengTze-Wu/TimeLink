...
def upgrade() -> None:
    ...
    sa.Column('line_group_id', sa.Text(), nullable=False, comment='Group Id For Line'),
    ...
    op.create_table('line_group_service',
    sa.Column('group_id', sa.Uuid(), nullable=False),
    sa.Column('service_id', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['group_id'], ['line_group.id'], ),
    sa.ForeignKeyConstraint(['service_id'], ['service.id'], ),
    sa.PrimaryKeyConstraint('group_id', 'service_id')
    )
    op.create_table('line_group_user',
    sa.Column('group_id', sa.Uuid(), nullable=False),
