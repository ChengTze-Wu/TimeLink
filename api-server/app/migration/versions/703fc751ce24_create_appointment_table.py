...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "reserved_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["service_id"], ["service.id"], name="service_user_account_service_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user_account.id"], name="service_user_account_user_id_fkey"
        ),
