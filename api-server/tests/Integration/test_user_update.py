...
def assert_status_code_and_error_message(
    ...
    response = client.put(
        "/api/users/3b27d130-9a97-4752-8690-d4d551120a83", json=json_data
    )
...
class TestUpdateUserApi:
    def test_invalid_content_type(self, client):
        response = client.put(
            "/api/users/3b27d130-9a97-4752-8690-d4d551120a83",
    ...
    def test_empty_json_body(self, client):
        response = client.put(
            "/api/users/3b27d130-9a97-4752-8690-d4d551120a83", json={}
        )
        assert response.status_code == 400
        response_messages = " ".join(response.json["message"])
    ...
    def test_invalid_input(self, client, field, value, expected_message):
